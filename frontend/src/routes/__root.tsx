  ...
  head: () => ({
    meta: [
      ...
      { title: "HireMeAI — Interview a candidate's AI" },
      {
        name: "description",
        content:
          "Recruiters can interview an AI representation of a candidate, grounded strictly in their resume.",
      },
      { property: "og:title", content: "HireMeAI — Interview a candidate's AI" },
      {
    ...
    <QueryClientProvider client={queryClient}>
      <div className="flex min-h-screen flex-col">
        ...
        <footer className="border-t border-border py-6 text-center text-xs text-muted-foreground">
          HireMeAI · AI answers are grounded in the candidate's resume.
        </footer>
      </div>
    </QueryClientProvider>
  );
